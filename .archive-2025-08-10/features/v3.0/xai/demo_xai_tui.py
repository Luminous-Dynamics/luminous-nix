...
from src.luminous_nix.nlp.intent_engine import IntentEngine
from src.luminous_nix.tui.app import NixForHumanityApp
from src.luminous_nix.xai.causal_engine import CausalXAI, ExplanationLevel
from src.luminous_nix.xai.confidence_calculator import ConfidenceCalculator
...
DEMO_SCENARIOS = {
    ...
    "maya_adhd": ["install discord now", "update system fast", "wifi fix"],
    "dr_sarah": [
...
class XAITUIDemo:
    ...
    async def run_interactive(self):
        ...
        print(
            "  • Press Ctrl+E to cycle explanation levels (Simple → Detailed → Technical)"
        )
