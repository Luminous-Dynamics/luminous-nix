...
def test_basic_xai():
    ...
    context = {"channels_updated_recently": False, "security_updates_available": True}
    ...
    error_explanation = xai_engine.explain_error(
        error, {"action": "install", "package": "firefox"}
    )
...
def test_explanation_formatting():
    ...
    for persona in personas:
        ...
        formatted = xai_engine.format_explanation_for_display(
            explanation, ExplanationDepth.STANDARD, persona
        )
...
def test_confidence_calculation():
    ...
    for scenario in scenarios:
        ...
        confidence = xai_engine._calculate_confidence(
            scenario["intent"], scenario["context"]
        )
