...
class RepairMechanism:
    ...
    def _init_repair_templates(self):
        ...
        self.repair_templates = {
            ...
            RepairStrategy.APOLOGIZE: {
                "mild": ["I apologize for the confusion.", "Sorry about that mix-up."],
                "moderate": [
    ...
    def generate_repair_strategy(
        self, error_context: dict, trust_state: TrustState, user_state: dict
    ) -> dict:
        """
    ...
    def _assess_rupture_severity(self, error_context: dict, user_state: dict) -> str:
        ...
        if frustration > 0.7 or stress > 0.7:
            return "severe"
        if frustration > 0.4 or stress > 0.4:
            return "moderate"
        return "mild"

    def _plan_repair_sequence(
        self, strategies: list[RepairStrategy], severity: str
    ) -> list[str]:
    ...
    def _record_repair(self, repair_result: dict):
        ...
        """,
            (repair_id, json.dumps(repair_result)),
        )
    ...
    def mark_repair_outcome(self, repair_id: str, successful: bool, user_response: str):
        """
