...
try:
    ...
    op = NixOperation(type=OperationType.SEARCH, packages=["firefox"])
...
try:
    ...
    metrics.record_operation(operation_type="test", duration=0.1, success=True)
...
3. Enable in production: export LUMINOUS_NIX_ENHANCED=true
"""
)
