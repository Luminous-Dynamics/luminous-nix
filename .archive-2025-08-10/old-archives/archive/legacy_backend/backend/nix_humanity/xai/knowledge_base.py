...
class CausalKnowledgeBase:
        ...
        return {
            ...
            "edges": [
                CausalEdge(
                    ...
                    "direct",
                    0.9,
                    "User need determines package selection",
                ),
                CausalEdge(
                    "package_match",
                    ...
                    "direct",
                    0.8,
                    "Better match increases success",
                ),
                CausalEdge(
                ...
                CausalEdge(
                    ...
                    "direct",
                    0.6,
                    "Preferences influence selection",
                ),
                CausalEdge(
                    "user_preference",
                    "installation_method",
                    "direct",
                    0.5,
                    "Preferences affect method choice",
                ),
                CausalEdge(
                    "installation_method",
                    "installation_success",
                ...
                CausalEdge(
                    ...
                    "direct",
                    0.7,
                    "Good match increases satisfaction",
                ),
            ],
        }
        ...
        return {
            ...
            "edges": [
                ...
                CausalEdge(
                    ...
                    "direct",
                    1.0,
                    "Success required for improvement",
                ),
            ],
        }
        ...
        return {
            ...
            "edges": [
                CausalEdge(
                    ...
                    "direct",
                    0.8,
                    "Problems trigger rollback",
                ),
                CausalEdge(
                    "previous_generation_stable",
                    "rollback_success",
                    "direct",
                    0.9,
                    "Stable target helps",
    ...
    def get_model(self, operation: str) -> dict | None:
    ...
    def get_treatments(self, operation: str) -> list[str]:
        ...
        return [node.id for node in model["nodes"] if node.node_type == "treatment"]
    ...
    def get_outcomes(self, operation: str) -> list[str]:
        ...
        return [node.id for node in model["nodes"] if node.node_type == "outcome"]
