...
from ..core.error_handler import ErrorCategory, ErrorContext, error_handler

logger = logging.getLogger(__name__)


def with_error_handling(operation: str, category: ErrorCategory | None = None):
    """
...
def with_timing(name: str | None = None):
    """
        ...
        def wrapper(*args, **kwargs):
            ...
            while attempt < max_attempts:
                try:
                    ...
                    logger.warning(
                        f"{func.__name__} failed (attempt {attempt}/{max_attempts}), retrying in {current_delay}s"
                    )
