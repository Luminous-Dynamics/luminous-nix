...
class EpisodicLayer:
    ...
    def record_interaction(
        ...
        """,
            (interaction_id, json.dumps(properties)),
        )
    ...
    def record_error(
        self, error_message: str, context: dict, interaction_id: str | None = None
    ) -> str:
        ...
        return [
            {
                ...
                "resolution": (
                    json.loads(row["resolution"]) if row["resolution"] else None
                ),
            }
            for row in results
        ]
