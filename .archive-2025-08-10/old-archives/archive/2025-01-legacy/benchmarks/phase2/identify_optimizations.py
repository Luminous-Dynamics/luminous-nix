...
class OptimizationAnalyzer:
    ...
    def profile_component(self, name: str, func, *args, **kwargs):
        ...
        self.profile_data[name] = {"stats": ps, "output": s.getvalue()}
    ...
    def analyze_nlp_optimizations(self):
        ...
        self.profile_component("NLP: Parse Simple", nlp.parse, "install firefox")
    ...
    def calculate_priority_scores(self):
        ...
        for opp in self.opportunities:
            ...
            opp.priority_score = (impact_score * opp.potential_savings_ms) / (
                complexity_score * 10
            )
    ...
    def generate_optimization_plan(self):
        ...
        plan = {
            ...
            "total_potential_savings_ms": sum(
                o.potential_savings_ms for o in self.opportunities
            ),
            "phases": {},
        }
        ...
        print(
            f"Total Potential Savings: {sum(o.potential_savings_ms for o in self.opportunities):.1f}ms"
        )
        ...
        for i, opp in enumerate(self.opportunities[:3], 1):
            print(
                f"{i}. {opp.technique} ({opp.component}): {opp.potential_savings_ms:.1f}ms savings"
            )
