...
def test_consciousness_orb():
    ...
    try:
        from nix_for_humanity.tui.app import ConsciousnessOrb
...
def test_command_history():
    ...
    try:
        from nix_for_humanity.tui.app import CommandHistory
...
def main():
    ...
    if passed == total:
        ...
        print("  poetry run python -c 'from nix_for_humanity.tui.app import run; run()'")
    else:
