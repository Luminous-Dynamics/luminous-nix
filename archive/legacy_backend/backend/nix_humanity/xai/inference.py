...
class CausalInferenceEngine:
    ...
    def __init__(
        ...
        model_builder: Optional[CausalModelBuilder] = None
    ):
        ...
        for method in estimation_methods:
            try:
                ...
                estimates.append({
                    ...
                    'confidence_intervals': self._extract_confidence_intervals(estimate)
                })
            except Exception as e:
    ...
    def _extract_confidence_intervals(self, estimate: Any) -> Optional[Tuple[float, float]]:
        ...
        for col in data.columns:
            ...
            if data[col].dtype in ['float64', 'int64', 'bool']:
                ...
                influence = self._calculate_influence(
                    col, correlation, model, decision
                )
    ...
    def perform_counterfactual_analysis(
        self,
        decision: Decision,
        counterfactual_context: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
        ...
        for orig, cf in zip(original_factors, cf_factors):
