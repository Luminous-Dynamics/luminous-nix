...
from core.executor import SafeExecutor, ValidationResult
from core.intent import Intent, IntentType
from api.schema import Request, Result
    ...
    async def test_privilege_escalation_prevention(self):
        ...
        for attempt in escalation_attempts:
            ...
            if response.success:
                ...
                assert 'sudo' not in response.text.lower() or 'elevation required' in response.text.lower()
