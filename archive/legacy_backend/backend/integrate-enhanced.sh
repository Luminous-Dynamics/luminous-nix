...
# Security settings
NIX_HUMANITY_VALIDATE_INPUT=true
NIX_HUMANITY_SAFE_MODE=false
EOF
...
echo "3. Test in production: export NIX_HUMANITY_ENHANCED=true && ask-nix 'list generations'"
echo
echo "To rollback if needed:"
echo "  export NIX_HUMANITY_ENHANCED=false"
