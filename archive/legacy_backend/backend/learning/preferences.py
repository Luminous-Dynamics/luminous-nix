...
class PreferenceManager:
    ...
    def set_preference(self, user_id: str, key: str, value: Any, confidence: float = 0.5):
    ...
    def _update_personality_preference(self, user_id: str, personality: str):
        ...
        personality_scores = current_prefs.get('personality_scores', {}).get('value', {})
    ...
    def _update_personality_traits(self, user_id: str, personality: str, confidence: float):
        ...
        if personality in trait_adjustments:
            current_traits = self.get_preferences(user_id).get('personality_traits', {}).get('value', {})
            ...
            for trait, adjustment in trait_adjustments[personality].items():
                ...
                new_value = max(0.0, min(1.0, current_value + (adjustment * confidence)))
                current_traits[trait] = new_value
                
            self.set_preference(user_id, 'personality_traits', current_traits, confidence)
    ...
    def get_user_profile(self, user_id: str) -> Dict[str, Any]:
        ...
        profile = {
            'user_id': user_id,
            'preferred_personality': preferences.get('preferred_personality', {}).get('value', 'friendly'),
