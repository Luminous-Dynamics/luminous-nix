...
from nixos_backend import NixOSBackend, OperationType
...
async def demo_performance_comparison():
    ...
    print(f"  - Command parsing: 50ms")
    await asyncio.sleep(0.05)
    print(f"  - Shell spawning: 100ms")
    await asyncio.sleep(0.1)
    print(f"  - Output parsing: 50ms")
    await asyncio.sleep(0.05)
...
async def demo_sacred_trinity_workflow():
    ...
    executor = NaturalLanguageExecutor()
    request = ExecutionRequest(
        query="install visual studio code",
