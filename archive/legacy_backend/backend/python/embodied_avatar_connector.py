...
from emotion_system import EmotionSystem, EmotionNLPConnector
...
class MinimalAvatar:
    ...
    def draw(self):
        ...
        for i in range(3):
            ...
            pygame.draw.circle(self.screen, glow_color + (glow_alpha,), 
        ...
        for particle in self.particles:
            ...
            pygame.draw.circle(self.screen, particle_color + (alpha,),
