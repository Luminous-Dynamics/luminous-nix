...
def process_query():
    ...
    try:
        ...
        if session_id not in sessions:
            sessions[session_id] = {"created": datetime.utcnow(), "interactions": 0}
    ...
    return jsonify(
        {
            ...
            "session": {
                ...
                "last_interaction": session.get(
                    "last_interaction", session["created"]
                ).isoformat(),
            },
            "timestamp": datetime.utcnow().isoformat(),
        }
    ...
    return jsonify(
        {
            ...
            "capabilities": {
                ...
                "execution_modes": ["dry_run", "safe", "full", "learning"],
                "rate_limits": {
                    "query": "30 per minute",
...
if __name__ == "__main__":
    ...
    logger.info("Starting Nix for Humanity API Server")
