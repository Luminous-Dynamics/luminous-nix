...
def fix_module_paths():
    ...
    module_fixes = {
        "luminous_nix.core.bayesian_knowledge_tracer": "luminous_nix.research.dynamic_user_modeling",
        "luminous_nix.learning.feedback_collector": "luminous_nix.core.feedback",
        "scripts.core.headless_engine": "luminous_nix.core.headless_engine",
        "core.headless_engine": "luminous_nix.core.headless_engine",
        "core.jsonrpc_server": "luminous_nix.core.jsonrpc_server",
    }
...
def fix_test_imports():
    ...
    test_fixes = {
        "tests/unit/test_headless_engine.py": [
            ("from scripts.core.headless_engine", "from luminous_nix.core.headless_engine"),
        ],
