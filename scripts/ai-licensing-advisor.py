...
class AILicensingAdvisor:
    ...
    def _populate_model_licenses(self, cursor):
        ...
        models = [
            ...
            (
                ...
                "Llama-2",
                "Mixed",
                "Conditional - Requires compliance",
                True,
                False,
                False,
                True,
                "Custom license with commercial use restrictions for >700M MAU",
            ...
            (
                ...
                False,
                True,
                "Monthly active users < 700M for commercial use",
                "mistral-7b, gemma-7b",
            ...
            (
                ...
                "OpenRAIL-M",
                "LAION-2B",
                "Restricted - Check specific terms",
                True,
                True,
                False,
                True,
                "No illegal use, no harm, must display license",
            ...
            (
                ...
                "GPL-3.0",
                "Mixed",
                "Yes, but with copyleft obligations",
                False,
                True,
                True,
                True,
            ...
            (
                ...
                False,
                False,
                "Anthropic Terms of Service apply",
                "gpt-4, mistral-large",
            ...
            (
                ...
                False,
                True,
                "Google's Gemma license has specific terms",
    ...
    def _populate_license_details(self, cursor):
        ...
        licenses = [
            ...
            (
                ...
                True,
                False,
                "Share source code, preserve license",
                "Open source projects",
                "Proprietary software, SaaS without source disclosure",
            ),
            (
                "AGPL-3.0",
                ...
                True,
                True,
                "Share source code even for network use",
                "Open source SaaS",
                "Any proprietary software or closed-source SaaS",
            ),
            (
                "CC-BY-4.0",
            ...
            (
                ...
                True,
                False,
                "Use-based restrictions, display license",
                "Research, controlled commercial use",
                "Applications that might cause harm",
            ),
            (
                "Llama-2",
                ...
                False,
                False,
                "Accept license, <700M MAU for commercial",
            ...
            (
                ...
                True,
                False,
                "Attribution, follow Gemma terms",
    ...
    def _populate_compatibility_matrix(self, cursor):
        ...
        compatibilities = [
            ...
            (
                ...
                "Apache-2.0",
                True,
                "MIT is permissive, can be combined with Apache",
            ),
            ...
            (
                ...
                "Proprietary",
                False,
                "ShareAlike prevents proprietary use",
            ),
            # Special licenses
    ...
    def check_model_license(self, model_name: str) -> dict | None:
    ...
    def check_license_compatibility(self, license_a: str, license_b: str) -> dict:
        ...
        if result:
            return {"compatible": bool(result[0]), "notes": result[1]}
        return {
            "compatible": None,
            "notes": "No compatibility information available",
        }

    def get_license_details(self, license_name: str) -> dict | None:
    ...
    def format_license_advice(self, model_info: dict) -> str:
        ...
        if "Yes - Safe" in model_info["commercial_use"]:
            advice += (
                "✅ This model is safe for commercial use with minimal restrictions.\n"
            )
        elif "Conditional" in model_info["commercial_use"]:
            advice += (
                "⚠️ Commercial use is allowed but check the specific terms carefully.\n"
            )
    ...
    def check_use_case_compatibility(self, model_name: str, use_case: str) -> dict:
        ...
        if any(
            term in use_case.lower()
            for term in ["commercial", "business", "startup", "company"]
        ):
            if "No" in model_info["commercial_use"]:
                ...
                advice.append(
                    f"Check specific terms: {model_info['special_restrictions']}"
                )

        # Check SaaS compatibility
        if any(
            term in use_case.lower() for term in ["saas", "api", "service", "cloud"]
        ):
            if not model_info["saas_compatible"]:
                suitable = False
                reasons.append(
                    "License requires source code disclosure for network use"
                )
                advice.append("Avoid AGPL-licensed models for SaaS applications")

        # Check proprietary use
        if any(
            term in use_case.lower() for term in ["proprietary", "closed", "private"]
        ):
            if model_info["share_alike"] or "GPL" in model_info["base_license"]:
                suitable = False
                reasons.append(
                    "License requires sharing modifications under same terms"
                )
                advice.append(
                    "Use MIT or Apache-2.0 licensed models for proprietary software"
                )
