...
from .plugin_base import FeaturePlugin, PersonalityPlugin, PluginBase, PluginInfo
...
class PluginLoader:
    ...
    def load_plugin(self, module_name: str) -> PluginBase | None:
        """
        ...
        try:
            ...
            for name, obj in inspect.getmembers(module):
                if (
                    ...
                    and obj not in [PluginBase, PersonalityPlugin, FeaturePlugin]
                ):
                    # Create instance
                    plugin_instance = obj()
                    break
    ...
    def apply_personality(
        self, response: str, personality: str, context: dict[str, Any]
    ) -> str:
        """
