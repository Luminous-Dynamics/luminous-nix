...
class MigrationExample:
    ...
    def get_solution(self, intent: dict) -> dict:
        ...
        if self.use_headless:
            ...
            return {
                ...
                "explanation": (
                    response.solution.explanation if response.solution else ""
                ),
            }
        # Legacy implementation
    ...
    def process_with_feedback(self, query: str, collect_feedback: bool = True) -> dict:
        ...
        if self.use_headless:
            ...
            context = Context(collect_feedback=collect_feedback, personality="friendly")
        ...
        return {"response": response_text, "feedback_collected": feedback_collected}
    ...
    def _should_use_headless_for(self, feature: str) -> bool:
        ...
        feature_flags = {
            ...
            "cache": os.getenv("HEADLESS_CACHE", "false") == "true",
            "feedback": os.getenv("HEADLESS_FEEDBACK", "true") == "true",
        }
