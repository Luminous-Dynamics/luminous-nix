...
class NixOSRebuildAPIDiscovery:
    ...
    def find_nixos_rebuild_binary(self) -> Path | None:
    ...
    def find_python_module(self, binary_path: Path) -> Path | None:
    ...
    def explore_api_capabilities(self):
        ...
        try:
            ...
            if hasattr(models, "Profile"):
                ...
                print("  - Profile class available for system profile management")
