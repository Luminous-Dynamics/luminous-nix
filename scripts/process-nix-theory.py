...
class NixTheoryProcessor:
    ...
    def process_best_practices(self):
        ...
        practices_file = (
            self.docs_dir / "best-practices" / "collected_best_practices.json"
        )
        ...
        for anti in practices.get("anti_patterns", []):
            qa_pairs.append(
                {
                    "q": "Is this a good practice in Nix: "
                    + anti.replace("Avoid ", "").replace("Don't ", ""),
            ...
            qa_pairs.append(
                {
                    ...
                    "a": pattern
                    + " This follows Nix best practices for maintainable and reproducible configurations.",
            ...
            qa_pairs.append(
                {
                    ...
                    "a": security
                    + " This is important for maintaining a secure Nix environment.",
                    "category": "security",
                }
            )
        ...
        print(
            f"✓ Created {len(qa_pairs)} Q&A pairs and {len(instructions)} instructions"
        )
