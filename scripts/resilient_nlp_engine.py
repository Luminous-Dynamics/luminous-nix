...
class EnhancedPatternTier(NLPTier):
    ...
    def get_capabilities(self) -> NLPCapabilities:
        return NLPCapabilities(
            ...
            limitations=["Limited to known patterns", "No complex reasoning"],
        )
...
class BasicPatternTier(NLPTier):
    ...
    def get_capabilities(self) -> NLPCapabilities:
        return NLPCapabilities(
            ...
            features=["Keyword detection", "Basic commands", "Fast response"],
            limitations=[
...
class ResilientNLPEngine:
    ...
    def __init__(self):
        self.tiers = [MistralLLMTier(), EnhancedPatternTier(), BasicPatternTier()]
        ...
        for tier in self.available_tiers:
            try:
                ...
                self.performance_history.append(
                    {"tier": tier.__class__.__name__, "time": elapsed, "success": True}
                )
    ...
    def get_status_message(self) -> str:
        ...
        if isinstance(self.active_tier, EnhancedPatternTier):
    ...
    def get_performance_report(self) -> dict:
        ...
        for entry in self.performance_history:
            ...
            if tier not in tier_stats:
                tier_stats[tier] = {"count": 0, "total_time": 0, "failures": 0}
...
def demonstrate_nlp_tiers():
    ...
    for query in test_queries:
        ...
        try:
            ...
            print(
                f"🎯 Intent: {result['intent']} (confidence: {result['confidence'] * 100:.0f}%)"
            )
