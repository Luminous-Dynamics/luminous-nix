...
# Read the file
with open(
    "/srv/luminous-dynamics/11-meta-consciousness/nix-for-humanity/tests/unit/test_executor_comprehensive.py",
) as f:
    lines = f.readlines()
...
for i, line in enumerate(lines):
    ...
    # Fix lines that start with 8 spaces and contain type=IntentType
        ...
        i > 0
        and "type=IntentType" in line
        and line.startswith("        ")
        or i > 0
        and "entities=" in line
        and line.startswith("        ")
        or i > 0
        and "confidence=" in line
        and line.startswith("        ")
        or i > 0
        and "raw_input=" in line
        and line.startswith("        ")
    ):
