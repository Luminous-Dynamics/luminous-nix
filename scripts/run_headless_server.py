...
def main():
    ...
    socket_path = os.environ.get(
        "NIX_FOR_HUMANITY_SOCKET", "/tmp/nix-for-humanity.sock"
    )
    ...
    server = JSONRPCServer(engine, socket_path=socket_path, tcp_port=tcp_port)
    ...
    logger.info("✅ Nix for Humanity Headless Server running")
