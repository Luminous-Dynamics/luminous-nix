...
def main():
    ...
    # Test search
    print("\n### Search Intent:")
    search_result = manager.handle_intent(
        "search_package", {"query": "search for firefox", "package": "firefox"}
    )
    ...
    install_result = manager.handle_intent(
        "install_package", {"package": "firefox", "execute": False}
    )
