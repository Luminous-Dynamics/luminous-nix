...
class TestExplainableSelfMaintenanceOrchestrator:
    ...
    async def orchestrator(self, mock_config, temp_dir):
        ...
        with (
            patch(
                "nix_for_humanity.infrastructure.explainable_self_maintenance_orchestrator.SelfMaintenanceSystem"
            ) as mock_maintenance,
            patch(
                "nix_for_humanity.infrastructure.explainable_self_maintenance_orchestrator.CausalMaintenanceExplainer"
            ) as mock_explainer,
            patch(
                "nix_for_humanity.infrastructure.explainable_self_maintenance_orchestrator.ConstitutionalAIValidator"
            ) as mock_constitutional,
            patch(
                "nix_for_humanity.infrastructure.explainable_self_maintenance_orchestrator.InvisibleExcellenceEngine"
            ) as mock_excellence,
        ):
            # Mock the components
