...
from nix_for_humanity.core.executor import CommandExecutor
from nix_for_humanity.core.knowledge import NixKnowledgeBase
from nix_for_humanity.types import ExecutionMode, PersonalityStyle, Query


class TestNixForHumanityCore:
...
class TestEducationalErrors:
    ...
    def test_error_translation(self):
        ...
        from nix_for_humanity.core.educational_errors import translate_error
...
class TestPerformance:
    ...
    def test_response_time(self):
        ...
        with patch("nix_humanity.core.backend.NixForHumanityBackend") as MockBackend:
            ...
            start = time.time()
            query = Query(text="test", mode=ExecutionMode.EXPLAIN)
            response = backend.process(query)
